...
const Register = () => {
    ...
    return (
        <div style={{marginLeft:'20%',border:'1px solid grey',width:'35%',paddingLeft:'5%',backgroundColor:"lightPink"}}>
            <h1>Register</h1>
            <form onSubmit={handleSubmit}>
                ...
                <input style={{width:'50%',height:'20px',marginLeft:'6%',backgroundColor:"skyblue",border:'none',marginBottom:'10px'}} type='submit' value='Register' /><br />
            </form>
        </div>
    )
}
